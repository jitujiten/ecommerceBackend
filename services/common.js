...
exports.invoiceTemplate = async function (order) {
  return `<!DOCTYPE html>
  <html>
  <head>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
              <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                ...
                <h3 style="margin: 0; font-size: 20px; font-weight: 700; letter-spacing: -1px; line-height: 48px; background-color: green; color: white; padding: 10px;">PayMent Method: ${
                  order.payMentMethod
                }</h3>
              </td>
            </tr>
              ...
              <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  ${order.items.map((item) => {
                    return `<tr>
                        <td align="left" width="50%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${item.product.title}</td>
                  ...
                  <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                    <tr>
                      <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        ...
                        <p><strong>${order.selectAddress.name}</strong></p>
                        <p><strong>${order.selectAddress.email}</strong></p>
                        <p><strong>${order.selectAddress.phone}</strong></p>
                        <p>${order.selectAddress.street}</p>
                        <p>${order.selectAddress.city}</p>
                        <p>${order.selectAddress.state}</p>
                        <p>${order.selectAddress.pinCode}</p>
                      </td>
                    </tr>
                  </table>
                </div>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                ...
                <p style="margin: 0;">${order.selectAddress.street}</p>
                <p style="margin: 0;">${order.selectAddress.city}</p>
                <p style="margin: 0;">${order.selectAddress.state}</p>
              </td>
            </tr>
            <!-- end unsubscribe -->
